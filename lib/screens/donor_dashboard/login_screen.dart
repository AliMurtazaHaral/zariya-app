...
import 'package:firebase_auth/firebase_auth.dart';
import 'package:zariya/screens/donor_dashboard/dashboard_screen.dart';
import 'package:zariya/screens/donor_dashboard/signup_screen.dart';
import 'package:zariya/screens/donor_signup_screen.dart';
...
class _DonorLoginScreenState extends State<DonorLoginScreen> {
  ...
  void signIn(String email, String password) async {
    await FirebaseAuth.instance
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context)=>DonorDashboardScreen())),
    })
        .catchError((e) {
...
class _ForgetPasswordScreenState extends State<ForgetPasswordScreen>
  ...
  Future<void> resetPassword(String email) async {
    if (emailController.text.isNotEmpty) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context)=>DonorLoginScreen()));
    } else {
