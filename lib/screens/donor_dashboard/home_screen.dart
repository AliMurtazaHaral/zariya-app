...
import '../person_dashboard/compaign_form.dart';
import '../person_dashboard/drawer/navigation_drawer_screen.dart';
...
class _DonorHomeScreenState extends State<DonorHomeScreen> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance
        ...
        .get()
        .then((value) {
      loggedInUser = UserModel.fromMapDonorRegistration(value.data());
      setState(() {
